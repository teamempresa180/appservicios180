...
void main() {
  ...
  testWidgets('shows the four status tabs', (tester) async {
    ...
    expect(find.widgetWithText(ChoiceChip, 'Pendientes'), findsOneWidget);
    expect(find.widgetWithText(ChoiceChip, 'En progreso'), findsOneWidget);
    expect(find.widgetWithText(ChoiceChip, 'Finalizadas'), findsOneWidget);
    expect(find.widgetWithText(ChoiceChip, 'Canceladas'), findsOneWidget);
  });
  ...
  testWidgets('selecting a tab only changes its visual selection', (
    ...
    final chipBefore = tester.widget<ChoiceChip>(
      find.widgetWithText(ChoiceChip, 'Finalizadas'),
    );
